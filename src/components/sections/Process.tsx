        ...
        <div className="grid md:grid-cols-4 gap-6 md:gap-10 max-w-6xl mx-auto">
          {c.steps.map((step: any, i: number) => (
            <div key={i} className="relative group">
              <div className="h-full p-6 rounded-2xl bg-card border border-border hover:shadow-lg transition-all backdrop-blur-sm flex flex-col">
              ...
              {i < c.steps.length - 1 && (
                <div className="hidden md:flex absolute top-1/2 -translate-y-1/2 left-full w-10 items-center justify-center z-10 text-muted-foreground/40">
